...
# Script para debugar o problema de SQL formatting

sql_fields = """nome_completo, endereco, numero, bairro, cep, cidade, estado, telefone, ponto_referencia, genero, idade,
...
sql_values = """%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s"""

# Contar campos
fields = [f.strip() for f in sql_fields.replace('\n', ' ').split(',') if f.strip()]
values = [v.strip() for v in sql_values.split(',') if v.strip()]

print(f"Número de campos: {len(fields)}")
print(f"Número de placeholders: {len(values)}")
print(f"Diferença: {len(fields) - len(values)}")
...
if len(fields) != len(values):
    ...
    print(f"\nPlaceholders: {len(values)} %s")
else:
    print("✅ Número de campos e placeholders está correto")
