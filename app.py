                ...
                try:
                    if comp['tipo_arquivo'].startswith('image/'):
                        ...
                        try:
                            ...
                            print(f"🔍 PDF {comp['nome_arquivo']} tem {total_pages} páginas")
                            ...
                            for page_num, page in enumerate(pdf_reader.pages, 1):
                                try:
                                    ...
                                    print(f"❌ Erro na página {page_num}: {page_error}")
                                    elements.append(Paragraph(f"Página {page_num}: (erro ao extrair texto)", styles['Italic']))
                            
                        except Exception as pdf_error:
                            print(f"❌ Erro ao processar PDF {comp['nome_arquivo']}: {pdf_error}")
